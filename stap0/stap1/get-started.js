...
let sumTotaal = nCount;

//Laat de rekensom zien op het scherm van de gast
//label.textContent="Leroy Andwoord &#58;" + addend1 + "&#43" + addend2 + sumTotaal;
let preNum=getNumber1()+ getNumber2();

label.textContent= "Leroy Andrade antwoordt: " + getNumber1() + " + " + getNumber2() +" = "+ preNum.toFixed(1);

//console.log(addend1 + \"=\" + addend2 + sumTotaal);
}
